  ...
  <div class="card">
    ...
    <div class="" tabindex="-1" id="offcanvasAddUser" aria-labelledby="offcanvasAddUserLabel">
      <div class="offcanvas-header border-bottom">
        <h6 id="offcanvasAddUserLabel" class="offcanvas-title">Edit finances</h6>
        <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
      </div>
      <div class="offcanvas-body mx-0 flex-grow-0">

        <form action='{{route("finances.update", $obj->id)}}' method='post' enctype='multipart/form-data'>
...
<div class='mb-3'>
  ...
  <input type="number" class="form-control" name="amount" id="amount" value="{{ $obj->amount }}" step="0.01" required />
</div>


<div class='mb-3'>
  <label for="date" class="form-label">Date</label>
  <input type="date" class="form-control" name="date" id="date" value="{{ $obj->date }}" required />
</div>


<div class='mb-3'>
  <label for="comment" class="form-label">Comment</label>
  <textarea class="form-control" name="comment" id="comment">{{ $obj->comment }}</textarea>
</div>
