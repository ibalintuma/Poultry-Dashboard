  ...
  <div class="card">
    ...
    <div class="" tabindex="-1" id="offcanvasAddUser" aria-labelledby="offcanvasAddUserLabel">
      <div class="offcanvas-header border-bottom">
        <h6 id="offcanvasAddUserLabel" class="offcanvas-title">Edit Stock Quantity</h6>
        <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
      </div>
      <div class="offcanvas-body mx-0 flex-grow-0">

        <form action='{{route("stock_quantities. update", $obj->id)}}' method='post' enctype='multipart/form-data'>
          ...
          <div class="mb-3">
            ...
            <select class="form-select" id="exampleFormControlSelect1"
                    aria-label="Default select" name='type'>
              <option value="manual" {{ $obj->type == 'manual' ? 'selected' : '' }} >Manual</option>
              <option value="auto" {{ $obj->type == 'auto' ? 'selected' : '' }}>Auto</option>
